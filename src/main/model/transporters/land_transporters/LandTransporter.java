...
public abstract class LandTransporter extends Transporter {
    ...
    public LandTransporter(TransporterID transporterID, Player owner, Resource[] resources, Transporter transporterCargo, ParentNode parentNode, int movementSpeed) {
